                ...
                <div class="page-head">
                    <div class="container">
                        ...
                        <div class="page-title">
                            <h1>Tambah Data Klasifikasi Air</h1>
                        </div>
                    </div>
                </div>
                <!-- END PAGE HEAD-->
                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Tambah Klasifikasi Air</span>
                            </li>
                        </ul>
                                ...
                                <div class="col-md-6">
                                    <div class="portlet light">
                                        ...
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" role="form" action="<?=base_url('klasifikasi/insert');?>" method="POST">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Jenis Klasifikasi</label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" placeholder="Jeni Klasifikasi" name="jenis_klasifikasi" id="jenis_klasifikasi" required="" title="Jenis Klasifikasi harap diisi" data-toggle="tooltip">
