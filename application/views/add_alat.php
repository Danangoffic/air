                                    ...
                                    <div class="portlet light">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject bold uppercase"> Form Tambah Alat</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" role="form" action="<?=base_url('alat/insert');?>" method="POST">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Nama Alat</label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" placeholder="Nama Alat" name="nama_alat" id="nama_alat" required="" title="Nama Alat" data-toggle="tooltip">
