                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet box green">
                                        ...
                                        <div class="portlet-body flip-scroll">
                                            <div class="row">
                                                <form action="<?= base_url('Users/update') ?>" method="POST" class="form-body col-sm-6">
                                                    ...
                                                    <div class="portlet-body form">
                                                        <div class="form-body">
                                                            <div class="fomr-group">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input class="form-control" type="text" minlength="3" name="username" required="" id="username" autocomplete="off" autofocus value="<?= $data->username ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="portlet-body form">
                                                        <div class="form-body">
                                                            <div class="fomr-group">
                                                                <label class="control-label col-sm-6" for="password">New Password&nbsp;</label>
                                                                <div class="col-sm-6">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <select name="user_class" id="user_class" class="form-control">
                                                                        <optgroup>Pilih Userclass Pengguna
                                                                            <option value="admin" <?= ($data->user_class == "admin") ? "selected" : ""; ?> label="Admin">Admin</option>
                                                                            <option value="penguji" <?= ($data->user_class == "penguji") ? "selected" : ""; ?> label="Penguji">Penguji</option>
                                                                        </optgroup>
                                                                    </select>
                                                                </div>
                                                            </div>
